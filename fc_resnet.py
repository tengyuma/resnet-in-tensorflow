...
def dense_inference(input_tensor_batch, n, reuse):
    ...
    #TODO: k = something tunable
    #TODO: layer 1: convoluational layer/fc_layer + reshaping that maps data to dim k, output layer layer_base
    ...
    #TODO: initializer needs to be tuned.
