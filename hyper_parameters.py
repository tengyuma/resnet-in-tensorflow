...
tf.app.flags.DEFINE_string('version', 'test_dense', '''A version number defining the directory to save
...
tf.app.flags.DEFINE_float('weight_decay', 0.0000, '''scale for l2 regularization''')
...
## for the dense inference model
tf.app.flags.DEFINE_integer('k', 500, '''width of each layer''')
tf.app.flags.DEFINE_integer('ell', 100, '''number of blocks''')
